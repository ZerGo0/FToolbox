...
class TagDiscoveryWorker implements Worker {
  ...
  private seedTags = [
    'teen', 'young', 'petite', 'blonde', 'brunette', 
    'amateur', 'cute', 'pussy', 'ass', 'boobs',
    'fyp', 'nsfw', 'nude', 'naked', 'sexy'
  ];
  ...
  async run(): Promise<void> {
    ...
    try {
      ...
      logger.info(`Tag discovery completed. Discovered: ${discoveredTags.size} unique tags, Added: ${newTags} new tags, Errors: ${errors}`);
    } catch (error) {
