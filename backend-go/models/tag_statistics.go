...
type TagStatistics struct {
	...
	PostChange24h        int64     `gorm:"not null;default:0;column:post_change_24h" json:"postChange24h"`
	PostChangePercent24h float64   `gorm:"not null;default:0;column:post_change_percent_24h" json:"postChangePercent24h"`
